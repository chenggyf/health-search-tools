    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function getAnswers(self) {
                treat_answer = $("input[name='treat_answer']:checked").val();
                $(self).next().find("input[name='treat_answer']").val(treat_answer);
                treat_trustworthiness = $("input[name='treat_trustworthiness']:checked").val();
                $(self).next().find("input[name='treat_trustworthiness']").val(treat_trustworthiness);
                treat_factualSupport = $("input[name='treat_factualSupport']:checked").val();
                $(self).next().find("input[name='treat_factualSupport']").val(treat_factualSupport);
                treat_ppositive = $("input[name='treat_ppositive']:checked").val();
                $(self).next().find("input[name='treat_ppositive']").val(treat_ppositive);
                treat_epositive = $("input[name='treat_epositive']:checked").val();
                $(self).next().find("input[name='treat_epositive']").val(treat_epositive);
                treat_effective = $("input[name='treat_effective']:checked").val();
                $(self).next().find("input[name='treat_effective']").val(treat_effective);
                treat_popularity = $("input[name='treat_popularity']:checked").val();
                $(self).next().find("input[name='treat_popularity']").val(treat_popularity);
                treat_recommend = $("input[name='treat_recommend']:checked").val();
                $(self).next().find("input[name='treat_recommend']").val(treat_recommend);

                diagnose_answer = $("input[name='diagnose_answer']:checked").val();
                $(self).next().find("input[name='diagnose_answer']").val(diagnose_answer);
                diagnose_trustworthiness = $("input[name='diagnose_trustworthiness']:checked").val();
                $(self).next().find("input[name='diagnose_trustworthiness']").val(diagnose_trustworthiness);
                diagnose_factualSupport = $("input[name='diagnose_factualSupport']:checked").val();
                $(self).next().find("input[name='diagnose_factualSupport']").val(diagnose_factualSupport);
                diagnose_ppositive = $("input[name='diagnose_ppositive']:checked").val();
                $(self).next().find("input[name='diagnose_ppositive']").val(diagnose_ppositive);
                diagnose_epositive = $("input[name='diagnose_epositive']:checked").val();
                $(self).next().find("input[name='diagnose_epositive']").val(diagnose_epositive);
                diagnose_effective = $("input[name='diagnose_effective']:checked").val();
                $(self).next().find("input[name='diagnose_effective']").val(diagnose_effective);
                diagnose_popularity = $("input[name='diagnose_popularity']:checked").val();
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#1title1').html("<a oncontextmenu='return false;' href='NewServlet' target='_blank' onclick='return Go(this);'>"
                                    ...
                                    + "<input id='1treatment1' name='term' value='treatment'/>"
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (experiential === "0.0") {
                                ...
                                $('#1experiential10').html("<img src='img/experience_030.gif' height='105' width='80'>");
                            }
                            else if (experiential >= 0.35 && experiential < 0.45) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks1').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks1').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks2').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks2').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks3').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks3').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks4').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks4').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks5').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks5').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks6').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks6').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks7').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks7').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks8').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks8').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks9').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            }
                            else {
                                $('#3infoLinks9').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
                ...
                try {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (infoLinks === "0.0") {
                                $('#3infoLinks10').html("<img src='img/lyme_no.gif' height='20' width='20'>");
                            } else {
                                $('#3infoLinks10').html("<img src='img/lyme_yes.gif' height='20' width='20'>");
                            }
                        }
                    });
                } catch (err) {
...
<!--                    Imagine you have a friend who has been complaining of a rash, headaches, and extreme fatigue.-->
                ...
                <h4>
                    ...
                    This friend wants your help learning about how lyme disease is diagnosed and treated. 
                </h4><br>
                <!--                <h4>
            ...
            <div id ="1" class="option" style="display:none;">
                <div style="margin-left: 2.5%; max-width: 95%" class="page-header">
                    <p class="taskHeader">
                        ...
                        At left are search results about how to diagnose lyme disease.
                        <br><br>
                        ...
                        <div style="margin-left:3%;margin-top: 3%;margin-right: 3%;">
                            <div>
                                <table>
                                    <tr>
                                        <td>
                                            <p><img src="img/people_sphere.gif" height='40' width='40'>&nbsp;&nbsp;<img src="img/lymeFont.jpg" height="200" width="200"></p>
                                        </td>                                      
                                    </tr>    
                                </table>
                            </div>
...
<!--                                            <img src="img/people_sphere.gif" height='40' width='40'>-->
                ...
                <div id="12" class="container" style="margin-bottom: 20px; margin-right: 1%;height:600px; width: 48.5%;display: block;overflow:scroll;border: 1px solid;border-color: #0088CC;float: right">
                    <div style="margin-left:2.5%;">
                        <div id="121">
                            <h4>What answer would you give your friend?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <textarea name="treat_answer" class="form-control" rows="4" style="min-width:600px"></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div><br><br> 
                        ...
                        <div id="122"  style="max-width:95%">
                            <h4>How trustworthy is the approach you suggest?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_trustworthiness" value="0Very trustworthy"/>
                                    </td>
                                    <td>
                                        &nbsp;Very trustworthy
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_trustworthiness" value="1Somewhat trustworthy"/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_trustworthiness" value="2Not very trustworthy"/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_trustworthiness" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                        ...
                        <div id="123"  style="max-width:95%">
                            <h4>How much factual support is there for the approach you suggest?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_factualSupport" value="0A lot of factual support"/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_factualSupport" value="1Some factual support"/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_factualSupport" value="2Not a lot of factual support"/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_factualSupport" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="124"  style="max-width:95%">
                            <h4>Are patients positive approach you suggest?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_ppositive" value="0Very positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Very positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_ppositive" value="1Not positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Not positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_ppositive" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="125"  style="max-width:95%">
                            <h4>Are experts positive about the approach you suggest?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_epositive" value="0Very positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Very positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_epositive" value="1Not positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Not positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_epositive" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="126" style="max-width:95%">
                            <h4>How effective is the approach you suggest?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_effective" value="0Very effective"/>
                                    </td>
                                    <td>
                                        &nbsp;Very effective
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_effective" value="1Somewhat effective"/>
                                    </td>
                                    <td>
                                        &nbsp;Somewhat effective
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_effective" value="2Not very effective"/>
                                    </td>
                                    <td>
                                        &nbsp;Not very effective
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_effective" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="127"  style="max-width:95%">
                            <h4>How popular is the approach you suggest?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_popularity" value="0Very popular"/>
                                    </td>
                                    <td>
                                        &nbsp;Very popular
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_popularity" value="1Somewhat popular"/>
                                    </td>
                                    <td>
                                        &nbsp;Somewhat popular
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_popularity" value="2Not very popular"/>
                                    </td>
                                    <td>
                                        &nbsp;Not very popular
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_popularity" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="128" style="max-width:95%">
                            <h4>Would you recommend this approach to your friend?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_recommend" value="0Strongly recommend"
                                    </td>
                                    <td>
                                        &nbsp;Strongly recommend
                                    </td>    
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_recommend" value="1Recommend"
                                    </td>
                                    <td>
                                        &nbsp;Recommend
                                    </td>    
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_recommend" value="2Not recommend"
                                    </td>
                                    <td>
                                        &nbsp;Not recommend
                                    </td>    
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="treat_recommend" value="3Cannot tell from results"
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>    
            ...
            <div id ="3" class="option" style="display:none">
                <div style="margin-left: 2.5%; max-width: 95%" class="page-header">
                    <p class="taskHeader">
                        At left are search results about how to treat lyme disease.
                        <br><br>
                        Please click on the results that look helpful and then answer the questions on the right.                           
                    </p>
                    <table> 
...
<!--                                            <img src="img/people_sphere.gif" height='40' width='40'>-->
                    ...
                    <div style="margin-left:2.5%;">
                        <div id="321" style="max-width:95%">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <textarea name="diagnose_answer" class="form-control" rows="4" style="min-width:600px"></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div><br><br>
                        ...
                        <div id="322"  style="max-width:95%">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_trustworthiness" value="0Very trustworthy"/>
                                    </td>
                                    <td>
                                        &nbsp;Very trustworthy
                                    </td>                                   
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_trustworthiness" value="1Somewhat trustworthy"/>
                                    </td>
                                    <td>
                                        &nbsp;Somewhat trustworthy
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_trustworthiness" value="2Not very trustworthy"/>
                                    </td>
                                    <td>
                                        &nbsp;Not very trustworthy
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_trustworthiness" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="323"  style="max-width:95%">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_factualSupport" value="0A lot of factual support"/>
                                    </td>
                                    <td>
                                        &nbsp;A lot of factual support
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_factualSupport" value="1Some factual support"/>
                                    </td>
                                    <td>
                                        &nbsp;Some factual support
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_factualSupport" value="2Not a lot of factual support"/>
                                    </td>
                                    <td>
                                        &nbsp;Not a lot of factual support
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_factualSupport" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="324"  style="max-width:95%">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_ppositive" value="0Very positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Very positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_ppositive" value="1Not positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Not positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_ppositive" value="2Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="325"  style="max-width:95%">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_epositive" value="0Very positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Very positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_epositive" value="1Not positive"/>
                                    </td>
                                    <td>
                                        &nbsp;Not positive
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_epositive" value="2Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="326"  style="max-width:95%">
                            <h4>How effective is the approach you suggest?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_effective" value="0Very effective"/>
                                    </td>
                                    <td>
                                        &nbsp;Very effective
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_effective" value="1Somewhat effective"/>
                                    </td>
                                    <td>
                                        &nbsp;Somewhat effective
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_effective" value="2Not very effective"/>
                                    </td>
                                    <td>
                                        &nbsp;Not very effective
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_effective" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="327"  style="max-width:95%">
                            <h4>How popular is the approach you suggest? </h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_popularity" value="0Very popular"/>
                                    </td>
                                    <td>
                                        &nbsp;Very popular
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_popularity" value="1Somewhat popular"/>
                                    </td>
                                    <td>
                                        &nbsp;Somewhat popular
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_popularity" value="2Not very popular"/>
                                    </td>
                                    <td>
                                        &nbsp;Not very popular
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_popularity" value="3Cannot tell from results"/>
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>
                        ...
                        <div id="328" style="max-width:95%">
                            <h4>Would you recommend this approach to your friend?</h4>
                            <table>
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_recommend" value="0Strongly recommend"
                                    </td>
                                    <td>
                                        &nbsp;Strongly recommend
                                    </td>    
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_recommend" value="1Recommend"
                                    </td>
                                    <td>
                                        &nbsp;Recommend
                                    </td>    
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_recommend" value="2Not recommend"
                                    </td>
                                    <td>
                                        &nbsp;Not recommend
                                    </td>    
                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="diagnose_recommend" value="3Cannot tell from results"
                                    </td>
                                    <td>
                                        &nbsp;Cannot tell from results
                                    </td>    
                ...
                <div id="Next3" style="margin-left: 47.5%;">
                    ...
                    <form action="task" hidden="">
                        <input name="treat_answer" value="">
                        <input name="treat_trustworthiness" value="">
                        <input name="treat_factualSupport" value="">
                        <input name="treat_ppositive" value="">
                        <input name="treat_epositive" value="">
                        <input name="treat_effective" value="">
                        <input name="treat_popularity" value="">
                        <input name="treat_recommend" value="">
                        <input name="diagnose_answer" value="">
                        <input name="diagnose_trustworthiness" value="">
                        <input name="diagnose_factualSupport" value="">
                        <input name="diagnose_ppositive" value="">
                        <input name="diagnose_epositive" value="">
