 ...
 * @author Cheng Guo
 */
public class Ml2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String url = (String) session.getAttribute("2url" + urlNum + currentUser);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Ml2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
